...
<script setup>
import { fetchJewelImage, fetchJewelTypes } from '~/data/JewelDataApiFetcher';
...
const handleAddJewel = async () => {
  ...
  try {
    ...
    await saveJewel(jewelData, selectedFiles.value);
    ...
    if (error.response?.data) {
      ...
      alert(error.message || 'Error adding jewel. Please try again.');
    }
  } finally {
